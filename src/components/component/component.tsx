      ...
      <div className="grid w-full max-w-7xl grid-cols-1 gap-4 px-4 md:grid-cols-3 md:gap-8">
        <div className="flex items-center">
          <div className="grid gap-1">
            <h1 className="text-2xl font-bold leading-none">Central de Organização da Equipe</h1>
            <p className="text-sm leading-5 text-gray-500 dark:text-gray-400">Gerencie tarefas e projetos</p>
          </div>
                    ...
                    <Card className="mb-4" variant="muted">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          <CardTitle className="text-sm font-normal">Atualizar documentação</CardTitle>
                          <CardDescription className="text-sm font-normal">
                            Precisa adicionar novas capturas de tela
                          </CardDescription>
                        </div>
                        <div className="flex gap-2 text-xs">
                          <Button className="w-6 h-6 rounded-full border" size="icon" variant="outline">
                  ...
                  <div className="p-4">
                    <Card className="mb-4" variant="muted">
                      <div className="flex items-center gap-4">
                        <GripHorizontalIcon className="w-4 h-4 text-gray-500 dark:text-gray-400 handle cursor-move" />
                        <div className="flex-1">
                          <CardTitle className="text-sm font-normal">Adicionar novos componentes</CardTitle>
                          <CardDescription className="text-sm font-normal">
                  ...
                  <div className="p-4">
                    <Card className="mb-4" variant="muted">
                      <div className="flex items-center gap-4">
                        <GripHorizontalIcon className="w-4 h-4 text-gray-500 dark:text-gray-400 handle cursor-move" />
                        <div className="flex-1">
                          <CardTitle className="text-sm font-normal">Refatorar código</CardTitle>
                          <CardDescription className="text-sm font-normal">Otimizar desempenho</CardDescription>
                        </div>
                        <div className="flex gap-2 text-xs">
                          <Button className="w-6 h-6 rounded-full border" size="icon" variant="outline">
                            <FileEditIcon className="w-4 h-4" />
                  ...
                  <div className="p-4">
                    <Card className="mb-4" variant="muted">
                      <div className="flex items-center gap-4">
                        <GripHorizontalIcon className="w-4 h-4 text-gray-500 dark:text-gray-400 handle cursor-move" />
                        <div className="flex-1">
                          <CardTitle className="text-sm font-normal">Escrever notas de lançamento</CardTitle>
                          <CardDescription className="text-sm font-normal">
